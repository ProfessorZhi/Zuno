...
def test_stackless_compare_matrix_write_markdown():
    from agentchat.evals.rag_eval.run_stackless_compare_matrix import write_markdown
...
def test_stackless_compare_matrix_build_acceptance():
    from agentchat.evals.rag_eval.run_stackless_compare_matrix import _build_acceptance
