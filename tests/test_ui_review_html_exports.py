...
def test_ui_review_html_exports_exist_with_expected_fields():
    dashboard = (REPO_ROOT / "docs" / "ui-review" / "settings-shell-dashboard.html").read_text(encoding="utf-8")
    knowledge = (REPO_ROOT / "docs" / "ui-review" / "settings-shell-knowledge-config.html").read_text(encoding="utf-8")
    index = (REPO_ROOT / "docs" / "ui-review" / "settings-shell-pages-index.html").read_text(encoding="utf-8")
