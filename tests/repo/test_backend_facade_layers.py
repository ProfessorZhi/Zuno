...
SELECTED_EXPORTS = {
    ...
    "zuno.capability": {
        ...
        "CapabilityRecord": "zuno.platform.services.application.capabilities",
        "CapabilityRegistry": "zuno.platform.services.application.capabilities",
        "DynamicCapabilitySelector": "zuno.platform.services.application.capabilities",
        "ToolCard": "zuno.platform.services.application.capabilities",
        "ToolCardRegistry": "zuno.platform.services.application.capabilities",
    },
    "zuno.knowledge": {
        "GraphRAGExtractorConfig": "zuno.platform.services.graphrag.models",
        "GraphRAGProjectContract": "zuno.platform.services.graphrag.models",
        "GraphRAGProjectLoader": "zuno.platform.services.graphrag.project",
        "normalize_retrieval_mode": "zuno.platform.services.graphrag.models",
    },
    "zuno.platform": {
        "AccessScope": "zuno.platform.services.execution_policy",
        "ExecutionMode": "zuno.platform.services.execution_policy",
        "SecurityGate": "zuno.platform.security",
        "ZunoSpanBuilder": "zuno.platform.observability",
        "normalize_execution_mode": "zuno.platform.services.execution_policy",
    },
}
...
OLD_IMPORT_PATHS = [
    ...
    "zuno.platform.services.application.capabilities",
    "zuno.platform.services.graphrag.models",
    "zuno.platform.services.graphrag.project",
    "zuno.platform.services.execution_policy",
]
