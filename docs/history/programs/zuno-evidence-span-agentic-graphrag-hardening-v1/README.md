...
`.agent/programs/` 当前处于 completed snapshot，随后会恢复 no-active 前台状态。
...
- `current.md`：completed state、质量目标和 Current / Target / Future 边界。
...
- `PHASE08_hard-negative-eval-and-release-gate.md`：completed phase。
