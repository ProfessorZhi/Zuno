...
验收：release report 输出 `hard_negative_coverage`、`release_gate`、收益/成本/失败边界；本轮真实本地 paired eval 因 agentic profile 未完成而保持 `blocked_not_measured_due_to_agentic_profile_incomplete`，没有写成 measured pass。
