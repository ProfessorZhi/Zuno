    ...
    [
        ...
        (
            ...
            [
                ...
                "tests/evals/test_rag_eval_local_launcher.py",
                "tests/evals/test_stackless_compare_matrix.py",
            ],
        ),
        (
            "eval_entrypoints",
        ...
        (
            "verification_tests",
            [
                "tests/evals/test_rag_eval_local_scheme.py",
                "tests/evals/test_contract_eval_runner.py",
                ...
                "tests/legacy_guards/test_phase5_domain_runtime_paths.py",
                "tests/legacy_guards/test_phase5_general_agent_real_runtime_flow.py",
                "tests/retrieval/test_graph_retriever_local_runtime.py",
                "tests/evals/test_local_embedding_server.py",
                "tests/evals/test_local_rerank_server.py",
                "tests/evals/test_local_runtime_registry.py",
                "tests/evals/test_stackless_local_eval_contract_project_query_policy.py",
                "tests/evals/test_stackless_local_eval_manifest_filter.py",
                "tests/evals/test_stackless_local_eval_rerank_runtime.py",
                "tests/legacy_guards/test_phase11b_single_generalagent_cutover.py",
        ...
        (
            ...
            [
                ...
                "tests/legacy_guards/test_phase6_bundle_scope.py",
            ],
        ),
    ]
)
