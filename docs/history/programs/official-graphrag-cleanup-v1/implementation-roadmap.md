...
- Root `domain-packs/` assets have moved to
  `docs/history/domain-packs/root-contract-review/`; the old
  `src/backend/zuno/domain_packs/` asset copy has also been removed from the
  current package path and archived under `docs/history/domain-packs/`.
