...
Formal truth lives in `docs/`. Agent workflow aids live in `.agent/`. Superseded material moves to `docs/history/`.
...
- Phase 11C is in progress and still blocked overall. The current FastAPI
  ...
  under `docs/history/domain-packs/root-contract-review/`, Docker
...
- `docs/history/programs/knowledge-product-refactor-deep-graphrag-v1/`
