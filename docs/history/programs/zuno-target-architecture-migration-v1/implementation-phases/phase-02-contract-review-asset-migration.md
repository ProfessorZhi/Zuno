...
- Move reusable prompt/schema/eval assets to GraphRAG Project or eval fixture
  destinations.
- Archive superseded Domain Pack documentation under `docs/history/`.
...
- `docs/history/domain-packs/root-contract-review/` preserves the
  old root Domain Pack evidence.
- `docs/history/domain-packs/backend-package-contract-review/`
