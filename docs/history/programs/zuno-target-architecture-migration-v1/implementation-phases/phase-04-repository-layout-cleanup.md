...
- `docs/history/` is the only history archive.
...
Superseded migration specs were moved from active `docs/history/specs/`
to `docs/history/specs/`:
...
`docs/history/development/docs-and-readme-ready.md` note.

The superseded reference migration guide was also moved from
`docs/reference/history/migration.md` to
`docs/history/reference/migration.md`, leaving
`docs/history/` as the only tracked docs history archive.
