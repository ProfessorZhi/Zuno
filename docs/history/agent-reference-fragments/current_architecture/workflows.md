...
`docs/history/` is for old programs, replaced designs, stale migration plans, and closure records. History remains reachable, but it must not dominate the current reading path.
