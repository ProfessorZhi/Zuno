...
8. `PHASE08_tool-control-plane-approval-and-sandbox-runtime`：当前阶段，接通真实 executor、approval API/UI、credential broker 和 sandbox profile。
