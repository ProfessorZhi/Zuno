...
- `README.md` 和 `.agent/programs/current.md`：记录当前 `.agent/programs/` 处于 no-active 等待态，最近完成 program 是 `zuno-production-document-ingestion-and-thread-foundation-v1`，归档位置是 `docs/history/programs/zuno-production-document-ingestion-and-thread-foundation-v1/`。
