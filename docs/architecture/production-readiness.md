...
| Index / GraphRAG | 本地 BM25 / vector / graph index job runtime、manifest、retry、replay、retrieval payload、index adapter contract、manifest provenance / ACL / adapter status。 | 外部 Elasticsearch / Milvus / Neo4j、GraphRAG extraction、community report、RRF / rerank、index service operations。 |
