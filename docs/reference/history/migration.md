...
Zuno v2.2.0 是一个重大版本更新，主要变更是将 LangChain 从 0.x 版本升级到 1.0+ 版本。LangChain 1.0 引入了**革命性的架构变更**：
...
```bash
# 启动服务
# 从仓库根目录启动；当前 Phase 2 下 backend starts from `services/api`
...
### Zuno 相关
- [Zuno 技术文档](zuno.md)
- [API 文档](05_TopDown_题库学习/项目/02_项目映射/Zuno/docs/reference/api.md)
- [核心功能文档](core.md)
