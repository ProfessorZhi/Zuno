...
- architecture_refs:
  - docs/modules/06-agent-core-planning-control.md — § 1.5.1 用户到底想完成什么：TaskUnderstandingSnapshot
...
- architecture_refs:
  - docs/modules/06-agent-core-planning-control.md — § 1.5.1 用户到底想完成什么：TaskUnderstandingSnapshot
  - docs/architecture/architecture.md — § 8.3.1 从输入理解到 Memory Context 的统一链
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 5.2 为什么抽取出一个事实后不能直接写进长期记忆？
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 5.3 结构化观察：写入前的中间事实层
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 10.2 记忆抽取的三个实现层次
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 5.2 为什么抽取出一个事实后不能直接写进长期记忆？
  - docs/modules/03-knowledge-agentic-graphrag.md — § Knowledge 与 Memory 为什么不能互相冒充
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 5.4 Event、Semantic Fact 和时间不是同一个概念
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 5.4 Event、Semantic Fact 和时间不是同一个概念
  - docs/modules/05-memory-context.md — § 27.2 MemoryVersion 的失效与处置状态必须区分
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 5.5 Memory Capture Policy 决定观察的去向
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 5.5 Memory Capture Policy 决定观察的去向
  - docs/modules/09-security.md — § 26.1 Memory Scope、Poisoning 与来源撤销
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 27.1 MemoryWriteDecision：Governance 到 Version 的正式门
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 24.1 Conflict 不是覆盖
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 41.1 Memory Provenance 与来源失效传播
  - docs/modules/09-security.md — § 26.1 Memory Scope、Poisoning 与来源撤销
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
...
- architecture_refs:
  - docs/modules/05-memory-context.md — § 11.4 为什么 Memory Retrieval 不能直接等于 Context Injection？
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/10-observability-eval.md — § 27.1 Memory 与 Information Extraction 的质量闭环
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- docs/modules/10-observability-eval.md — § 26.1 Memory 与 Information Extraction 的质量闭环
