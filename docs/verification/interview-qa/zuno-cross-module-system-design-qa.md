...
- architecture_refs:
  - docs/architecture/architecture.md — § 7.13 四大主题统一端到端 Case
  - docs/modules/06-agent-core-planning-control.md — § 4.1 Deep Dive 04：统一端到端控制案例
...
- architecture_refs:
  - docs/modules/09-security.md — § 16. Decision Cache、一致性与 Epoch
  - docs/modules/09-security.md — § 50. Retry、Recovery、Idempotency 与 Reconcile
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  ...
  - docs/modules/03-knowledge-agentic-graphrag.md — § 47. 关键数据库约束
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  ...
  - docs/modules/10-observability-eval.md — § 29. AgenticGraphRAGTrace
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  ...
  - docs/modules/09-security.md — § 41. Final、Citation 与 Publication
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/11-infrastructure.md — § 20. CheckpointRecord 与 Domain Boundary
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/architecture/architecture.md — § 7.13 四大主题统一端到端 Case
- primary_domain: cross-module
- difficulty: L6
- interview_probability: HIGH
