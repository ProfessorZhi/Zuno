...
如果任务还包含项目背景、用户规模、团队协作、WorkBuddy/开源替代、交付过程或落地真实性，先进入 [`../architecture-red-blue/README.md`](../architecture-red-blue/README.md)。本目录继续只维护架构攻击题、Deep Dive Chain 和 Coverage；上层红蓝工作区调用这里的题库，不复制或另建第二套 QA 事实源。
