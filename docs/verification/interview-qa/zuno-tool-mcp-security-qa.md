...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 9. 唯一 Tool Invocation Boundary
  - docs/modules/08-tool-runtime.md — § 46. 固定执行顺序
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 4. Capability、Skill、Tool、API、SDK 和 MCP
  - docs/modules/08-tool-runtime.md — § 7. Cross-module Ownership
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 24. ToolDefinition、ToolVersion 与 ToolOperation
  - docs/modules/08-tool-runtime.md — § 40. Definition / Version / Installation 生命周期
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 30. PreparedToolAction
  - docs/modules/08-tool-runtime.md — § 53. 两阶段 Security Gate
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  - docs/modules/09-security.md — § 12. Agent、Task、Session 与用户权限交集
  - docs/modules/09-security.md — § 15. Authorization 算法与 Decision Explanation
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 12. 需要审批的副作用
  - docs/modules/09-security.md — § 29. PreparedToolAction 与 Approval
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 16. MCP Tool
  - docs/modules/08-tool-runtime.md — § 38. MCP 领域对象
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 20. UNKNOWN Effect 与 Reconciliation
  - docs/modules/08-tool-runtime.md — § 36. EffectReconciliation
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 47. 幂等和 Effect Assurance
  - docs/modules/11-infrastructure.md — § 44. 一致性与幂等原则
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 55. Secret 与 Credential
  - docs/modules/09-security.md — § 31. Secret 与 Credential Lease
- initial_coverage_status: PARTIAL
- coverage_status: FULL
...
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 57. Tool Input 和 Output Firewall
  - docs/modules/09-security.md — § 21. Prompt Injection 与 Memory Poisoning 防御
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 57. Tool Input 和 Output Firewall
- primary_domain: tool
- difficulty: L2
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、security
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 22. 并行与资源冲突
- primary_domain: tool
- difficulty: L5
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、concurrency
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 22. 并行与资源冲突
  - docs/modules/09-security.md — § 51. 时间、并发与 TOCTOU
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 51. Crash Cut Points
- primary_domain: tool
- difficulty: L7
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、recovery
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 51. Crash Cut Points
  - docs/modules/08-tool-runtime.md — § 48. Retry、Reconciliation 与 Replan
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 58. Mandatory Audit
- primary_domain: tool
- difficulty: L8
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、audit
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 58. Mandatory Audit
  - docs/modules/09-security.md — § 44. Audit、Trace 与 Evidence
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 63. Observability 与 SLO
- primary_domain: tool
- difficulty: L1
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、eval
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 63. Observability 与 SLO
  - docs/modules/09-security.md — § 61. Security Eval 与 Release Gate
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 12. 需要审批的副作用
- primary_domain: tool
- difficulty: L2
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、approval
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 9. 唯一 Tool Invocation Boundary
- primary_domain: tool
- difficulty: L3
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、flow
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 49. Failure Namespace
- primary_domain: tool
- difficulty: L4
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、failure
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 49. Failure Namespace
  - docs/modules/08-tool-runtime.md — § 48. Retry、Reconciliation 与 Replan
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 24. ToolDefinition、ToolVersion 与 ToolOperation
- primary_domain: tool
- difficulty: L7
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、version
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 68. Current 证据
- primary_domain: tool
- difficulty: L1
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、current
- architecture_refs:
  - docs/modules/08-tool-runtime.md — § 68. Current 证据
  - docs/modules/08-tool-runtime.md — § 75. 完成证据
- initial_coverage_status: FULL
- coverage_status: FULL
- gap_id: None
- status: Target
...
- source_type: ARCHITECTURE_STRESS
- source_ref: zuno-target: docs/modules/08-tool-runtime.md — § 4. Capability、Skill、Tool、API、SDK 和 MCP
- primary_domain: tool
- difficulty: L2
- interview_probability: HIGH
- resume_trigger: Tool Runtime、MCP、Permission、Effect、boundary
