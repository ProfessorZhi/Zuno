...
工程上继续保持 `KnowledgeGeneration lifecycle != task-level ReadinessDecision`，因为两者回答的是不同的问题。
...
### KnowledgeGeneration 必须可构建、验证、切换和回收
