...
它不证明生产 KMS、真实凭据材料托管、graph-level Checkpointer interrupt/resume、retention/prune、combined-service fault 或 PHASE04 closure。
...
该证据不能替代真实生产 KMS、graph-level Checkpointer interrupt/resume、retention/prune、combined-service fault 或完整跨服务恢复 cutover。
