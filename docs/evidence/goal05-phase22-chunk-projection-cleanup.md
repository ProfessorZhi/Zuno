...
- `ChunkModel` projection 仍存在，原因是 knowledge pipeline 的下游 RAG/Graph consumer 尚未全部退休 ChunkModel；workspace attachment 默认路径已经退出该 projection。
