...
Zuno 的架构文档由 `docs/architecture/overall-architecture.md`、`.agent/architecture/overall-architecture.md`、`docs/architecture/architecture.md`、`docs/architecture/`、`docs/architecture/architecture.html` 和 `.agent/references/` 共同治理。

- `docs/architecture/` 是人类可读的正式架构说明，也是 public architecture source。
- `docs/architecture/overall-architecture.md` 是文字总架构文档，用自然语言说清当前事实、目标分层、主链路和实施落点。
- `docs/` 应少而精，保留相对稳定、面向人的正式结论；不要把高频变化的执行细节、图清单、workflow change log 或 Agent 操作规则塞进 `docs/`。
- `docs/architecture/architecture.md` 是 Obsidian 风格架构总览 Markdown，维护章节结构、十类 Mermaid 架构视图和简短分析。
- `docs/architecture/architecture.html` 是唯一架构 HTML 展示页，不是唯一事实来源；它必须由 `docs/architecture/architecture.md` 和 `tools/agent/render_architecture.py` 生成，并与正式架构文档保持一致。
- `.agent/architecture/overall-architecture.md` 是 Agent 侧总架构维护文档，必须和 `docs/architecture/overall-architecture.md` 同步。
...
2. `docs/architecture/overall-architecture.md`
3. `.agent/architecture/overall-architecture.md`
4. `docs/architecture/*`
5. `docs/architecture/architecture.html`
6. `.agent/references/*`
7. `.agent/templates/*`
8. `.agent/programs/current.md` 或 `.agent/programs/implementation-roadmap.md`
9. `README.md` 中的架构摘要
...
总架构文档偏文字说明，架构 HTML 偏图形展示。总架构文字变更时必须同步 `docs/architecture/overall-architecture.md` 和 `.agent/architecture/overall-architecture.md`；架构图变更时必须先改 `docs/architecture/architecture.md`，再由 `tools/agent/render_architecture.py` 生成 `docs/architecture/architecture.html`。
...
1. `docs/architecture/overall-architecture.md`
2. `.agent/architecture/overall-architecture.md`
...
8. `.agent/README.md`
9. `.agent/system.yaml`
10. `.agent/references/current-program.md`
11. `.agent/references/docs-map.md`
12. `.agent/references/code-map.md`
13. `.agent/references/task-routing.md`
14. `.agent/references/workflow.md`
15. `.agent/references/project-map.md`
16. `.agent/references/architecture-docs-map.md`
17. `.agent/references/documentation-governance.md`
18. `.agent/references/architecture-update-policy.md`
19. `.agent/references/diagram-inventory.md`
20. `.agent/references/current-target-future-rules.md`
21. `.agent/references/workflow-governance.md`
22. `.agent/references/workflow-update-policy.md`
23. `.agent/references/workflow-maintenance-checklist.md`
24. `.agent/architecture/near-term/00-architecture-index.md`
25. `.agent/architecture/near-term/01-target-runtime-architecture.md`
26. `.agent/architecture/near-term/02-context-memory-architecture.md`
27. `.agent/architecture/near-term/03-capability-tool-retrieval-architecture.md`
28. `.agent/architecture/near-term/04-knowledge-graphrag-retrieval-fusion.md`
29. `.agent/architecture/near-term/05-repository-boundaries-and-acceptance-gates.md`
