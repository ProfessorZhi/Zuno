...
def verify_phase07_post_closure_consistency() -> list[str]:
    ...
    for label, path, phrases in [
        ...
        ("manifest", MANIFEST, ["current_phase: PHASE11", "id: PHASE07", "state: completed", "id: PHASE11", "state: ready"]),
        ("current", CURRENT, ["current_phase: PHASE11", "PHASE07 completed", "PHASE11 ready"]),
