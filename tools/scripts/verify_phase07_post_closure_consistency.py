...
def verify_phase07_post_closure_consistency() -> list[str]:
    ...
    for label, path, phrases in [
        ...
        ("manifest", MANIFEST, ["current_phase: PHASE19", "id: PHASE07", "state: completed", "id: PHASE08", "state: completed", "id: PHASE09", "state: completed", "id: PHASE10", "state: completed", "id: PHASE19", "state: ready"]),
        ("current", CURRENT, ["current_phase: PHASE19", "PHASE07 completed", "PHASE08 completed", "PHASE09 completed", "PHASE10 completed", "PHASE19 ready"]),
