...
DOCS_AND_README_READY_NOTE = "docs/history/development/docs-and-readme-ready.md"
...
GROUP_RULES: list[tuple[str, tuple[str, ...]]] = [
    ...
    (
        ...
        (
            ...
            "src/backend/zuno/platform/services/runtime_registry.py",
            "src/backend/zuno/platform/services/workspace/simple_agent.py",
            "src/backend/zuno/platform/services/embedding/",
            "src/backend/zuno/platform/services/llm/",
