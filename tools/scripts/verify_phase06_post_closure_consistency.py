...
def verify_phase06_post_closure_consistency() -> list[str]:
    ...
    for label, path, phrases in [
        ...
        ("manifest", MANIFEST, ["current_phase: PHASE09", "id: PHASE06", "state: completed", "id: PHASE07", "state: completed", "id: PHASE08", "state: completed", "id: PHASE09", "state: ready"]),
        ("current", CURRENT, ["current_phase: PHASE09", "PHASE06 completed", "PHASE08 completed", "PHASE09 ready"]),
