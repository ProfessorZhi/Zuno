    ...
    [
        ...
        (
            ...
            [
                ...
                "src/backend/agentchat/test/test_contract_graph_query_routing.py",
                "src/backend/agentchat/test/test_contract_graph_retriever.py",
                "src/backend/agentchat/test/test_domain_pack_loader.py",
                "src/backend/agentchat/test/test_domain_pack_runtime_flow.py",
                "src/backend/agentchat/test/test_domain_qa_graph_offline.py",
                "src/backend/agentchat/test/test_general_agent_domain_pack_runtime.py",
                "src/backend/agentchat/test/test_graph_retriever_local_runtime.py",
                "src/backend/agentchat/test/test_local_embedding_server.py",
                "src/backend/agentchat/test/test_local_rerank_server.py",
                "src/backend/agentchat/test/test_local_runtime_registry.py",
                "src/backend/agentchat/test/test_multi_agent_supervisor_graph_offline.py",
                "src/backend/agentchat/test/test_stackless_local_eval_contract_domain_pack.py",
                "src/backend/agentchat/test/test_stackless_local_eval_manifest_filter.py",
                "src/backend/agentchat/test/test_stackless_local_eval_rerank_runtime.py",
                "src/backend/agentchat/test/test_completion_domain_pack_runtime.py",
                "src/backend/agentchat/test/test_workspace_domain_pack_runtime.py",
                "src/backend/agentchat/test/test_agent_runtime_multi_agent.py",
