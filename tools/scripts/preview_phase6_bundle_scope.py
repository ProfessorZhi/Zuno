    ...
    [
        ...
        (
            ...
            [
                ...
                "tests/compat/test_local_rerank_server.py",
                "tests/compat/test_local_runtime_registry.py",
                "tests/compat/test_multi_agent_supervisor_graph_offline.py",
                "tests/compat/test_stackless_local_eval_contract_domain_pack.py",
                "tests/compat/test_stackless_local_eval_manifest_filter.py",
                "tests/compat/test_stackless_local_eval_rerank_runtime.py",
                "tests/compat/test_completion_domain_pack_runtime.py",
                "tests/compat/test_workspace_domain_pack_runtime.py",
