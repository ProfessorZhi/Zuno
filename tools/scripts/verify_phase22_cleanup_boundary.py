...
TESTS_REPO_CANONICAL_FILES = [
    ...
    REPO_ROOT / "tests" / "repo" / "test_phase2_graphrag_mainline_deepening.py",
    REPO_ROOT / "tests" / "repo" / "test_phase3_community_graphrag_v1.py",
    REPO_ROOT / "tests" / "repo" / "test_phase4_knowledge_config_v2_and_local_eval.py",
    REPO_ROOT / "tests" / "repo" / "test_phase4_global_drift_v1.py",
    ...
    REPO_ROOT / "tests" / "repo" / "test_phase11c_workspace_project_query_cutover.py",
    REPO_ROOT / "tests" / "repo" / "test_project_query_compatibility_boundaries.py",
    REPO_ROOT / "tests" / "repo" / "test_hardening01_community_runtime_contract.py",
    REPO_ROOT / "tests" / "repo" / "test_phase02_contract_review_asset_migration.py",
    REPO_ROOT / "tests" / "repo" / "test_phase6_agent_graphrag_pluginization.py",
    REPO_ROOT / "tests" / "repo" / "test_phase25_legacy_boundary_hardening.py",
    REPO_ROOT / "tests" / "repo" / "test_phase5_domain_runtime_paths.py",
    REPO_ROOT / "tests" / "repo" / "test_phase5_graphrag_index_filters.py",
    ...
    REPO_ROOT / "tests" / "repo" / "test_phase5_retrieval_modes.py",
