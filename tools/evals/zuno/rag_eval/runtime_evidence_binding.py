"""PHASE22 Runtime Evidence Binding Contract (validation only, v2).
...
Version 2 repairs the review findings from PR #58:
    ...
    def _check_receipt_reference_binding(
        ...
        for receipt in evidence.receipts:
            ...
            if receipt.receipt_type not in RECEIPT_OWNERS:
                ...
                # unknown types yields the single fixed code, reported once.
