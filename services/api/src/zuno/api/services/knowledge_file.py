...
class KnowledgeFileService:
    @classmethod
    def prepare_uploaded_file(cls, file_url: str) -> dict[str, object]:
        ...
        normalized_file_name = "_".join(parts[:-1]) + f".{ext_part}"
    ...
    async def delete_knowledge_file(cls, knowledge_file_id):
        ...
        await RagHandler.delete_documents_by_file(knowledge_file.id, knowledge_file.knowledge_id)
