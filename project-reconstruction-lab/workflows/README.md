...
这只是组合输入模型，不是新的事实源。背景、团队、交付、模型、部署和证据仍必须按 [00-charter/](../00-charter/mission.md) 的 Owner 路由回对应文档。任何组织、法院、客户、用户量、团队人数、部署历史或个人贡献都不能从 Architecture 反推。
...
三套工作流都必须服从 [00-charter/](../00-charter/mission.md)。Skill 的接口草案见 [../skills/](../skills/README.md)；当前不生成正式 `SKILL.md`。
