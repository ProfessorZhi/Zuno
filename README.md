...
当前 active Agent program 是 `zuno-target-architecture-runtime-full-implementation-v1`，阶段是 `PHASE11_web-desktop-surface-and-feedback-loop`。
