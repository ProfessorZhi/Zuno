...
| 编号 | 模块 | 正式模块文档 | 状态 |
| --- | --- | --- | --- |
| 01 | Product Surface | [`01-product-surface.md`](./01-product-surface.md) | 单一完整 Target 架构镜像 |
...
它统一定义 Product Surface 的北向边界、用户流程、Product-owned 对象、Command / Query / Product Projection / AuthorizedView / AvailableAction / SSE / ChannelDelivery、状态机、Failure、Recovery、安全、生命周期、目标代码、PostgreSQL 和完整验证闭环。不得创建额外 Product Surface 架构拆分文档。
