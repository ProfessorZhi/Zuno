...
- `docs/architecture/architecture.md` 是 Target / Proposed 文字总架构，不是 Current proof；`.agent/` 不保存架构镜像。
...
| 架构替换、GraphRAG 边界、仓库布局 | `docs/architecture/*`、`docs/modules/README.md`、`workflow.md`、`docs-map.md` | 架构重构流程；Current/Target 分开 |
