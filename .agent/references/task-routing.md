...
| 架构替换、GraphRAG 边界、仓库布局 | `docs/history/architecture-surface-cleanup-2026-06-30/agent-architecture/near-term/*`、`.agent/architecture/architecture.md`、`workflow.md`、`docs-map.md` | 架构重构流程；Current/Target 分开 |
