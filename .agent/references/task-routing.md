...
| 项目背景、历史事实 | `docs/project/README.md`、`project-background.md`、`project-fact-provenance.md` | Project Documentation |
| 项目为什么值得立项、为什么不只用通用平台 | `product-positioning-and-value.md`、`project-background.md`、总体架构 Part A | Project Documentation + Architecture |
| 技术面试 / 架构 Reviewer 连续追问 | `docs/project/review-question-map.md`，再按问题进入 Project / Architecture / Module / Evidence | 对应事实 Owner |
| 个人贡献 | `team-and-contributions.md`、历史任务级证据 | Project Documentation；不得由当前 Target 反推 |
| 文档结构、README、Agent 路由 | `workflow.md`、`docs-map.md`、验证地图 | Documentation |
| 阅读总体架构、理解系统 | `product-positioning-and-value.md`、`docs/architecture/README.md`、`architecture.md` Part A | Architecture |
...
- 产品定位文档如果发现必须新增 / 删除九个逻辑模块、扩大 Canonical Legal Kernel 或改变跨模块 Owner，不允许在 Project 文档里直接改架构，必须升级为 Architecture Gap。
