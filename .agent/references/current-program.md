...
`.agent/programs/` 当前 active program 是 `zuno-enterprise-document-ingestion-platform-v2`，当前 phase 是 `PHASE01_truth-source-and-gap-audit`。最近完成并归档的 program 是：
...
2. `zuno-enterprise-document-ingestion-platform-v2`
   - 状态：active。
   - 当前 phase：`.agent/programs/PHASE01_truth-source-and-gap-audit.md`。
