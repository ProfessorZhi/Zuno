...
把 `Model / Agent Core Runtime / Memory / Tool / Knowledge / Document Ingestion / Security / Trace-Eval / Platform` 写入正式目标架构，解释 planning 与 runtime 的关系，并把 Memory Layer 细化为 write-manage-read 记忆机制。
