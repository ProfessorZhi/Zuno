...
- Current phase: `PHASE06_evidence-aware-reranker.md`
...
- `PHASE06_evidence-aware-reranker.md`：当前 active phase。
- `PHASE07_claim-level-citation-binder.md` 到 `PHASE08_hard-negative-eval-and-release-gate.md`：后续 pending phase。
