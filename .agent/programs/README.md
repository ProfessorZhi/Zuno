...
- Current phase: `PHASE03_parser-worker-runtime-and-job-lifecycle.md`
...
- `PHASE03_parser-worker-runtime-and-job-lifecycle.md`：当前 phase，实现本地 parser worker / job lifecycle / retry / metrics。
