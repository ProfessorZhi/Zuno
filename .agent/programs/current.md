...
state: active
current_phase: `PHASE08_graphrag-knowledge-runtime-system.md`
...
8. `PHASE08_graphrag-knowledge-runtime-system.md`：active。GraphRAG、RAG fusion、knowledge extraction 和 drift 检索。
