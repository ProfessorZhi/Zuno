...
state: active
current_phase: `PHASE06_capability-toolcard-mcp-system.md`
...
6. `PHASE06_capability-toolcard-mcp-system.md`：active。ToolCard、Native BM25 tool search、MCP/tool policy。
