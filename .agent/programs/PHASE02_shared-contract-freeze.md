...
| `SelectedSkill` | Workstream F | `src/backend/zuno/agent/contracts.py` | pydantic | `skill_id, skill_version, selection_mode, reason, allowed_tools, required_evidence, retrieval_profile` | PHASE09, PHASE10, PHASE12, PHASE13 |
| `CapabilityPlan` | Workstream F | `src/backend/zuno/agent/contracts.py` | pydantic | `allowed_capabilities, allowed_tools, blocked_capability_reasons, approval_required_tools, executed_tools, risk_summary` | PHASE09, PHASE10, PHASE12, PHASE13 |
| `RetrievalPlan` | Workstream F | `src/backend/zuno/agent/contracts.py` | pydantic | `requested_profile, effective_profile, retrievers_used, fallback_reason, evidence_requirements` | PHASE09, PHASE10, PHASE12, PHASE13 |
...
| `PlannerOutput` | Workstream F | `src/backend/zuno/agent/contracts.py` | pydantic | `task_id, trace_id, strategy, selected_skill, capability_plan, retrieval_plan, plan_state, reflection_verdict, replan_decision, reflexion_lesson, trace_events` | PHASE09, PHASE10, PHASE12, PHASE13 |
