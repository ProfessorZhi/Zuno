...
- Program 2 的具体线程提示词已由 Program 1 PHASE07 生成，并随 Program 1 归档到 `docs/history/programs/zuno-production-document-ingestion-and-thread-foundation-v1/thread-prompts/`；启动 Program 2 时需要复制或刷新到 `.agent/programs/thread-prompts/` 并重新确认 UI 目标模式。
