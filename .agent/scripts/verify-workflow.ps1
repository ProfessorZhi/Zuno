...
Require-Path ".agent\programs\THREAD_A_root-docs-agent-hygiene-prompt.md"
Require-Path ".agent\programs\THREAD_B_backend-six-layer-audit-prompt.md"
Require-Path ".agent\programs\THREAD_C_tools-tests-generated-artifacts-prompt.md"
