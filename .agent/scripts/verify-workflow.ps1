...
if ($currentProgram -notmatch "state: active" -or $currentProgram -notmatch "active_program: zuno-evidence-span-agentic-graphrag-hardening-v1" -or $currentProgram -notmatch "current_phase: PHASE02_source-span-provenance-contract.md" -or $currentProgram -notmatch "latest_completed_program: zuno-launchable-enterprise-agentic-graphrag-full-closure-v1" -or $currentProgram -notmatch "docs/history/programs/zuno-launchable-enterprise-agentic-graphrag-full-closure-v1/") {
