...
if ($currentProgram -notmatch "state: active" -or $currentProgram -notmatch "active_program: zuno-real-unified-runtime-cutover-v1" -or $currentProgram -notmatch "current_phase: PHASE03_runtime-dependency-factory" -or $currentProgram -notmatch "latest_completed_program: zuno-unified-agent-runtime-closure-v1") {
