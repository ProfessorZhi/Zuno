...
- 当前已有 Agentic Retrieval Router、query method / citation / evidence trace contract、GraphRAG index pipeline contract 和 global community-only prior 边界；完整 LLM extraction、RRF/rerank 治理和外部 index platform 仍是 Target，并由后续 PHASE11 推进。
