...
def register_middleware(app: FastAPI):
    ...
    # Keep CORS outermost so streaming/error responses still include
    # cross-origin headers for the browser workspace client.
    app.add_middleware(
        CORSMiddleware,
...
if __name__ == "__main__":
    ...
    uvicorn.run("zuno.main:app", host="0.0.0.0", port=7860)
