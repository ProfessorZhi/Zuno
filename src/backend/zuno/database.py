"""Compatibility module for legacy ``zuno.database`` imports."""
...
_TARGET_PACKAGE = "zuno.platform.database"
_TARGET_PATH = Path(__file__).resolve().parent / "platform" / "database"
