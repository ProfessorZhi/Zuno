...
def build_wave1_contract_registry() -> ContractRegistry:
    ...
    return ContractRegistry(
        [
            ...
            _entry(DataServiceCapabilityV1, owner="Infrastructure", producers=("Infrastructure",), consumers=("ALL",)),
            _entry(TenantIsolationProfileV1, owner="Infrastructure", producers=("Infrastructure",), consumers=("Security", "ALL")),
            _entry(UpgradeCompatibilityProfileV1, owner="Infrastructure", producers=("Infrastructure",), consumers=("Infrastructure", "Observability")),
            _entry(AdapterConformanceProfileV1, owner="Infrastructure", producers=("Infrastructure",), consumers=("Infrastructure", "Observability")),
            _entry(ReleaseManifestV1, owner="Infrastructure", producers=("Infrastructure",), consumers=("Infrastructure", "Observability", "Product Surface")),
            _entry(InfrastructureCapabilityProfileV1, owner="Infrastructure", producers=("Infrastructure",), consumers=("ALL",)),
            _entry(ProductCommandV1, owner="Product Surface", producers=("Product Surface",), consumers=("Agent Core", "Security", "Observability")),
            ...
            _entry(SourceObjectRefV1, owner="Input / Document Ingestion", producers=("Input / Document Ingestion",), consumers=("Knowledge", "Observability")),
            _entry(KnowledgeVersionRefV1, owner="Knowledge", producers=("Knowledge",), consumers=("Product Surface", "Agent Core", "Memory")),
            _entry(MemoryContextRefV1, owner="Memory", producers=("Memory",), consumers=("Agent Core", "Product Surface")),
            _entry(CapabilityInvocationRefV1, owner="Capability", producers=("Capability",), consumers=("Agent Core", "Tool Runtime", "Observability")),
            _entry(ObservabilityEventRefV1, owner="Observability", producers=("ALL",), consumers=("Observability",)),
            _entry(InfrastructureLeaseRefV1, owner="Infrastructure", producers=("Infrastructure",), consumers=("Agent Core", "Tool Runtime", "Input / Document Ingestion")),
