...
class MCPUserConfigService:
    ...
    def _untested_meta(cls) -> Dict[str, Any]:
        return {
            ...
            cls.META_MESSAGE_KEY: "Config saved but not tested yet.",
    ...
    def _build_test_status(cls, meta: Dict[str, Any]) -> Dict[str, Any]:
        if not meta:
            return {
                "code": "untested",
                "label": "Untested",
                "detail": "No connectivity test has been executed yet.",
                "tools": [],
                "tested_at": None,
            }
        ...
        return {
            "code": status_code,
            "label": status_map.get(status_code, "Untested"),
            "detail": meta.get(cls.META_MESSAGE_KEY) or "No connectivity test has been executed yet.",
