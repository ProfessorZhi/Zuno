...
from agentchat.services.domain_pack.validators import DomainPackValidator
...
class DomainPackLoader:
    ...
    def load(self, pack_id: str | None) -> DomainPack | None:
        ...
        retrieval_policy_data = self._parse_simple_yaml(retrieval_policy_path.read_text(encoding="utf-8")) if retrieval_policy_path.exists() else {}
