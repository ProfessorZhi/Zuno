...
async def initialize_worker_runtime():
    ...
    # Import after settings are loaded so database engines use the runtime config.
    from agentchat.database.init_data import init_database
...
async def consume_forever(
    *,
    ...
    from agentchat.services.queue.client import QueueClient
