...
.model-editor-page {
  ...
  .edit-form-section {
    .form-container {
      ...
      border-color: var(--zuno-border-soft);
      box-shadow: var(--zuno-shadow-soft);
    }

    .form-header {
      .form-icon {
        background: var(--zuno-accent-soft);
        color: var(--zuno-accent);
    ...
    .edit-form {
      .form-section {
        .section-title {
          ...
          &::before {
            background: linear-gradient(135deg, var(--zuno-button-primary) 0%, var(--zuno-button-primary-hover) 100%);
          }
        }
      ...
      .form-actions {
        border-top-color: var(--zuno-border-soft);
        ...
        .action-btn {
          &.cancel-btn {
            ...
            &:hover {
              background: var(--zuno-button-soft);
              color: var(--zuno-text-primary);
            }
          }

          &.primary-btn {
            background: linear-gradient(180deg, var(--zuno-button-primary) 0%, var(--zuno-button-primary-hover) 100%);
            color: #fffdf9;
            border-color: transparent;
            box-shadow: 0 12px 24px rgba(201, 108, 45, 0.2);

            &:hover {
              background: linear-gradient(180deg, var(--zuno-highlight) 0%, var(--zuno-button-primary) 100%);
              box-shadow: 0 14px 28px rgba(201, 108, 45, 0.24);
            }
          }
        }
      }
