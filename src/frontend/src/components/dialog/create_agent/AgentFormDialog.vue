          ...
          <div class="dialog-header">
            <div class="header-left">
              <svg class="header-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 17.25V21H6.75L17.81 9.94L14.06 6.19L3 17.25Z" fill="#c96c2d"/>
              </svg>
                ...
                <div class="assistant-header">
                  <div class="assistant-avatar">
                    ...
                    <svg v-else width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 2L13.09 8.26L19 7L18.74 13.74L24 12L17.74 16.74L19 19L13.74 18.26L12 22L10.26 16.74L5 17L5.26 10.26L2 12L8.26 7.26L7 5L12.26 5.74L12 2Z" fill="#c96c2d"/>
                    </svg>
                  </div>
...
.custom-dialog-wrapper {
  .custom-dialog {
    ...
    border-color: rgba(214, 132, 70, 0.16) !important;
    box-shadow: 0 22px 60px rgba(130, 71, 31, 0.18) !important;
  }
  ...
  .action-buttons {
    background: rgba(255, 252, 247, 0.98) !important;
    border-color: rgba(214, 132, 70, 0.14) !important;
  }
  ...
  .assistant-avatar,
  .avatar-preview {
    border-color: rgba(214, 132, 70, 0.18) !important;
    background: rgba(223, 150, 88, 0.12) !important;
  }
  ...
  .section-header:hover {
    border-color: #c96c2d !important;
    background: rgba(248, 239, 230, 0.96) !important;
  }
  ...
  :deep(.el-button--primary) {
    background: linear-gradient(135deg, #d68446 0%, #c96c2d 100%) !important;
    border-color: transparent !important;
    color: #fffdf9 !important;
    box-shadow: 0 10px 18px rgba(194, 110, 46, 0.16) !important;
  }
  ...
  :deep(.el-button--primary:hover) {
    background: linear-gradient(135deg, #cb763b 0%, #b96028 100%) !important;
  }
  ...
  :deep(.el-select__wrapper.is-focused) {
    ...
    border-color: #c96c2d !important;
    box-shadow: 0 0 0 3px rgba(201, 108, 45, 0.12) !important;
  }
